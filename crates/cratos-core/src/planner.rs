...
11. `memory` — Save and recall explicit knowledge across sessions.
    **CRITICAL: When user says "기억해", "저장해", "기록해", "remember", "메모리 저장/수정" → YOU MUST call memory(action="save",...). NEVER respond with text only claiming you saved it.**
