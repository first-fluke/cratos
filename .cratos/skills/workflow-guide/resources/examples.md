...
Step 4: Spawn Priority 2 after P1 completes
  .cratos/skills/orchestrator/scripts/spawn-agent.sh frontend "TODO List UI" ./frontend

Step 5: Spawn Priority 3
  .cratos/skills/orchestrator/scripts/spawn-agent.sh qa "Security + Performance review" .
